        ...
        public static WebApplicationBuilder AddSerilog(this WebApplicationBuilder applicationBuilder)
        {
            try
            {
                ...
                Log.Logger = new LoggerConfiguration()
                    ...
                    .WriteTo.File("logs/BookUserManagement4User-log-{Date}.txt", rollingInterval: RollingInterval.Day, restrictedToMinimumLevel: Serilog.Events.LogEventLevel.Information)  // File logging
